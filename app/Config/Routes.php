...
$routes->group('admin', ['namespace' => 'App\Controllers\Admin'], function($routes) {
    ...
    $routes->group('', ['filter' => 'adminAuth'], function($routes) {
        ...
        $routes->post('successful-orders/(:num)/status', 'SuccessfulOrdersController::updateStatus/$1');
          ...
          $routes->post('ip-whitelist/create',    'IpWhitelistController::create');
          $routes->post('ip-whitelist/delete/(:num)', 'IpWhitelistController::delete/$1');
    });
});


// API Routes (IP-restricted via controller logic)
