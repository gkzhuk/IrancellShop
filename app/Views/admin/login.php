...
<head>
    ...
    <link href="https://gitcdn.ir/library/PersianFonts/vazir/style.css" rel="stylesheet" type="text/css" />
    <style>
        body { font-family: 'vazir', sans-serif; background-color: #f8f9fa; display: flex; align-items: center; justify-content: center; height: 100vh; }
